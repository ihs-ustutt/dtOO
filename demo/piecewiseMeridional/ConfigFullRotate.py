...
def createOFCase(container, bV, dC, stateLbl, indiv, h_inlet, h_shroud):
    ...
    from dtOOPythonApp.builder import combineGmsh_fullRotate
	
    container = combineGmsh_fullRotate(
    	label = "gv_mesh_combined",
	section = bV["gv_mesh"],
	numberOfSections = 24
    ...
    container = combineGmsh_fullRotate(
    	label = "meshLayers_combined",
	section = bV["meshLayers"],
	numberOfSections = 15,
        comPhys = ['inlet', 'outlet', 'hub', 'shroud'],
	rmPhys = ['periodic']
    ).buildExtract( container )
    
    for iNum in bV.getIndices("*"):
      ...
      dictRule = \
          ofOpenFOAMCase_setupWrapper.controlDict(
            ...
            PTPatches = ['gv_mesh_combined_inlet', 'gv_mesh_combined_outlet',
                        ...
                        'meshLayers_combined_inlet', 'meshLayers_combined_outlet',
                        'dt_mesh_inlet', 'dt_mesh_outlet'],
            FPatches = ['gv_mesh_combined_blade', 'ru_mesh_combined_blade'],
            libs = [
        ...
        setupRules = [
          ...
          ofOpenFOAMCase_setupWrapper.wallRuleString(
            "gv_mesh_combined_shroud",
            ["omega", "U", "p", "k", "nut"]
          ),
           ofOpenFOAMCase_setupWrapper.wallRuleString(
            "gv_mesh_combined_hub",
            ["omega", "U", "p", "k", "nut"]
          ),
          ofOpenFOAMCase_setupWrapper.wallRuleString(
            "gv_mesh_combined_blade",
            ["omega", "U", "p", "k", "nut"]
          ),
          #ofOpenFOAMCase_setupWrapper.cyclicAmiRuleString(
          #  "gv_mesh_combined_suction", "gv_mesh_pressure"
          #),
          ofOpenFOAMCase_setupWrapper.cyclicAmiRuleString(
            "gv_mesh_combined_outlet", "ru_mesh_combined_inlet",
            rotAxis = None,
            rotCentre = None
          ),
          ...
          # runner
          ofOpenFOAMCase_setupWrapper.wallRuleString(
            "ru_mesh_combined_hub",
            ["omega", "U", "p", "k", "nut"]
          ),
          ofOpenFOAMCase_setupWrapper.wallRuleString(
            "ru_mesh_combined_shroud",
            ["omega", "U", "p", "k", "nut"]
          ),
          ofOpenFOAMCase_setupWrapper.wallRuleString(
            "ru_mesh_combined_blade",
            ["omega", "U", "p", "k", "nut"]
          ),
          #ofOpenFOAMCase_setupWrapper.cyclicAmiRuleString(
          #  "ru_mesh_combined_suction", "ru_mesh_combined_pressure"
          #),
          ofOpenFOAMCase_setupWrapper.cyclicAmiRuleString(
            "ru_mesh_combined_outlet", "meshLayers_combined_inlet",
            rotAxis = None,
            rotCentre = None
          ),
          #ofOpenFOAMCase_setupWrapper.mixingPlaneRuleString(
          ...
          # mesh layers
          ofOpenFOAMCase_setupWrapper.wallRuleString(
            "meshLayers_combined_hub",
            ["omega", "U", "p", "k", "nut"]
          ),
          ofOpenFOAMCase_setupWrapper.wallRuleString(
            "meshLayers_combined_shroud",
            ["omega", "U", "p", "k", "nut"]
          ),
          #ofOpenFOAMCase_setupWrapper.cyclicAmiRuleString(
          #  "meshLayers_combined_periodic0", "meshLayers_combined_periodic1"
          #),
          ofOpenFOAMCase_setupWrapper.cyclicAmiRuleString(
            "meshLayers_combined_outlet", "dt_mesh_inlet", 
            rotAxis = None,
            rotCentre = None
          ),
          #ofOpenFOAMCase_setupWrapper.mixingPlaneRuleString(
