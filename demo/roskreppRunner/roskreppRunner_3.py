...
class roskreppRunner_3:
  ...
  def create( 
    ...
    alpha_1_1: float = 40.000,
    alpha_2_0: float = 17.723,
    alpha_2_1: float = 50.000,
    halfDivide = 0,
  ) -> dtOO.dtBundle:
    """Create machine.
    ...
    container = analyticSurface_threePointMeanplaneFromRatio(
        ...
        [
            ...
            dtOO.dtPoint2(0.75, (np.pi/180.) * 30.000),#42.189),
            dtOO.dtPoint2(0.50, (np.pi/180.) * 30.000),#42.189),
            dtOO.dtPoint2(0.25, (np.pi/180.) * 30.000),#42.189),
    ...
    container = vec3dTwoDInMap3dTo3d_approximateAndFullExtendMeanplane(
        ...
        [
            ...
            dtOO.dtPoint2(0.50, 0.025), #0.50
            dtOO.dtPoint2(1.00, 0.05) #0.75
        ],
        )(),
    ...
    container = rotatingMap2dTo3d_hubShroudCreate(
      ...
      shroudPoints = [
        ...
        # dtOO.dtPoint3(1.135, 0.00, -2.4255),
    ...
    dtOO.lVHOstateHandler().makeState("roskreppRunner_3_2")
...
def CreateAndShow( *args, **kwargs ):
  ...
  cc = roskreppRunner_3().create(*args, **kwargs)
