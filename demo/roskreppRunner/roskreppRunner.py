...
class roskreppRunner:
  ...
  def create( 
    self, 
    alpha_1_0: float = 35.00, #30.51
    alpha_1_1: float = 35.00, #67.74
    alpha_2_0: float = 12.50,
    alpha_2_1: float = 60.00,
    halfDivide = 0,
  ) -> dtOO.dtBundle:
    """Create machine.
      ...
      dtOO.jsonPrimitive(
        '{'
          '"option" : ['
            ...
            '{"name" : "geometry_render_resolution_u", "value" : "151"},'#-100 Genauigkeit der Flächen
            '{"name" : "geometry_render_resolution_v", "value" : "151"},'#-100 Genauigkeit der Flächen
            '{"name" : "geometry_render_resolution_w", "value" : "151"},'#-100 Genauigkeit der Flächen
    ...
    container = draftTubeCenterline(
      ...
      splinePoints = [
        ...
        # dtOO.dtPoint3(0.9625, 0.00, -5.4306),
        # dtOO.dtPoint3(1.4157, 0.00, -5.9041),
        # dtOO.dtPoint3(1.9687, 0.00, -6.1559),
        # dtOO.dtPoint3(2.5754, 0.00, -6.2869),
        # dtOO.dtPoint3(3.2146, 0.00, -6.2664),
        # dtOO.dtPoint3(3.8300, 0.00, -6.2002),
        # dtOO.dtPoint3(4.4304, 0.00, -6.0959),
        ...
        # dtOO.dtPoint3(0.9625, 0.00, -5.4306),
        # dtOO.dtPoint3(1.4157, 0.00, -5.9041),
        # dtOO.dtPoint3(1.9687, 0.00, -6.1059),
        # dtOO.dtPoint3(2.5754, 0.00, -6.1869),
        # dtOO.dtPoint3(3.2146, 0.00, -6.1164),
        # dtOO.dtPoint3(3.8300, 0.00, -6.0002),
        # dtOO.dtPoint3(4.4304, 0.00, -5.8459),
    ...
    container = draftTubeCenterline(
      ...
      splinePoints = [
        ...
        #test_1
        # dtOO.dtPoint3(4.4304, 0.00, -6.0959),
        # dtOO.dtPoint3(5.0680, 0.00, -5.9648),
        # dtOO.dtPoint3(5.7240, 0.00, -5.8032),
        # dtOO.dtPoint3(7.3635, 0.00, -5.4316),
        # dtOO.dtPoint3(9.6733, 0.00, -4.8620),
        # dtOO.dtPoint3(24.000, 0.00, -1.5524),

        #test_2
        # dtOO.dtPoint3(4.4304, 0.00, -5.8459),
        # dtOO.dtPoint3(5.0680, 0.00, -5.6648),
        # dtOO.dtPoint3(5.7240, 0.00, -5.4532),
        # dtOO.dtPoint3(7.3635, 0.00, -4.9816),
        # dtOO.dtPoint3(9.6733, 0.00, -4.2120),
        # dtOO.dtPoint3(24.000, 0.00,  1.0076),

        #test_3
        # dtOO.dtPoint3(4.4304, 0.00, -5.8459),
        # dtOO.dtPoint3(5.0680, 0.00, -5.6648),
        # dtOO.dtPoint3(5.7240, 0.00, -5.4532),
        # dtOO.dtPoint3(7.3635, 0.00, -4.7816),
        # dtOO.dtPoint3(9.6733, 0.00, -3.7120),
        # dtOO.dtPoint3(24.000, 0.00,  3.5876),
      ],
      order = 2
    ).buildExtract( container )
    ...
    container = rotatingMap2dTo3d_hubShroudCreate(
      "channel",
      shroudPoints = [
        # dtOO.dtPoint3(1.65, 0.00, 0.6),
        # dtOO.dtPoint3(1.4525, 0.00, 0.6),
        # dtOO.dtPoint3(1.51, 0.00, 0.0),
        dtOO.dtPoint3(1.65, 0.00, 0.815),
        dtOO.dtPoint3(1.50, 0.00, 0.815),
        dtOO.dtPoint3(1.432, 0.00, 0.568),
        dtOO.dtPoint3(1.51, 0.00, 0.0),
      ],
      hubPoints = [
        # dtOO.dtPoint3(1.65, 0.00, 1.50),
        # dtOO.dtPoint3(1.1475, 0.00, 1.50),
        # dtOO.dtPoint3(0.45, 0.00, 1.10),
        # dtOO.dtPoint3(0.35, 0.00, 0.90),
        # dtOO.dtPoint3(0.10, 0.00, 0.00),
        dtOO.dtPoint3(1.65, 0.00, 1.715),
        dtOO.dtPoint3(1.12, 0.00, 1.715),
        dtOO.dtPoint3(0.43, 0.00, 1.320),
        dtOO.dtPoint3(0.28, 0.00, 1.063),
        dtOO.dtPoint3(0.10, 0.00, 0.000),
      ],
      order = 2,
    ...
    container = analyticSurface_threePointMeanplaneFromRatio(
        ...
        [
            dtOO.dtPoint2(1.00, (np.pi/180.) * alpha_1_0), #0.00
            dtOO.dtPoint2(0.00, (np.pi/180.) * alpha_1_1), #1.00
        ],
        1
        )(),
        alphaTwo = scaOneD_scaCurve2dOneDPointConstruct(
        [
            dtOO.dtPoint2(1.00, (np.pi/180.) * alpha_2_0), #0.00
            dtOO.dtPoint2(0.00, (np.pi/180.) * alpha_2_1), #1.00
        ],
        1
        )(),
        ratioX = scaOneD_scaCurve2dOneDPointConstruct(
        [
            dtOO.dtPoint2(1.00, 0.50), #0.00, 0.50 #shroud
            dtOO.dtPoint2(0.75, 0.50), #0.00, 0.50
            dtOO.dtPoint2(0.50, 0.50), #0.00, 0.50
            dtOO.dtPoint2(0.25, 0.50), #0.00, 0.60
            dtOO.dtPoint2(0.00, 0.50), #1.00, 0.70
        ],
        1
        )(),
        ...
        [
            ...
            dtOO.dtPoint2(0.50, 2.25),
            dtOO.dtPoint2(0.00, 2.00),
        ],
        1
        )(),
        ...
        [
            ...
            dtOO.dtPoint2(0.75, 0.0),#0.05
            dtOO.dtPoint2(0.50, -0.00),
            dtOO.dtPoint2(0.25, -0.0),#-0.05
            dtOO.dtPoint2(0.00, -0.0),#-0.15
        ],
        1
        )(),
        ...
        [
            ...
            dtOO.dtPoint2(1.00, 0.55), #shroud
            dtOO.dtPoint2(0.75, 0.85),
            dtOO.dtPoint2(0.50, 0.75),
            dtOO.dtPoint2(0.25, 0.85),
            dtOO.dtPoint2(0.00, 0.93),
        ...
        [
            ...
            dtOO.dtPoint2(1.00, 1.3), #shroud
            dtOO.dtPoint2(0.75, 1.5),
            dtOO.dtPoint2(0.50, 1.1),
            dtOO.dtPoint2(0.25, 0.9),
            dtOO.dtPoint2(0.00, 1.00),
        ],
        2
        )(),
    ...
    container = vec3dTwoDInMap3dTo3d_approximateAndFullExtendMeanplane(
        ...
        [
            ...
            dtOO.dtPoint2(0.25, 1.00), # neu hinzugekommen
            dtOO.dtPoint2(0.50, 1.00), # (0.50, 0.00)
            dtOO.dtPoint2(0.75, 1.00), # neu hinzugekommen
            dtOO.dtPoint2(1.00, 1.00)
        ]
        )(),
        ratioBladeExt = scaOneD_scaCurve2dOneDPointConstruct(
        [
            dtOO.dtPoint2(0.00, 0.05), #0.25
            dtOO.dtPoint2(0.50, 0.15), #0.50
            dtOO.dtPoint2(1.00, 0.20) #0.75
        ],
        )(),
    ...
    container = map3dTo3dGmsh_gridFromChannelAndBlocks(
      ...
      nBoundaryLayers = 15, #4
      nElementsSpanwise = 75, #30
      nElementsNormal = 25, #6
      firstElementSizeHubToShroud = 0.0006, #0.01
      firstElementSizeNormalBlade = 0.0006, #0.01
      bladeHubElementSize = scaOneD_scaCurve2dOneDPointConstruct(
        [
          dtOO.dtPoint2(0.00, 0.005), #0.01 Austritt
          dtOO.dtPoint2(0.25, 0.007), #0.45, 0.007
          dtOO.dtPoint2(0.50, 0.0006), #0.007
          dtOO.dtPoint2(0.75, 0.007), #0.55, 0.007
          dtOO.dtPoint2(1.00, 0.005), #0.01
        ], 1
      )(),
    ...
    container = rotatingMap2dTo3d_hubShroudCreate(
      ...
      shroudPoints = [
        ...
        # dtOO.dtPoint3(1.470, 0.00, 0.00),
        # dtOO.dtPoint3(1.470, 0.00, 1.715),
      ...
      hubPoints = [
        dtOO.dtPoint3(0.10, 0.00, 0.00),
        dtOO.dtPoint3(0.10, 0.00, -2.4255),
      ],
      order = 1,
      rotVector = dtOO.dtVector3(0, 0, 1)
    ).buildExtract( container )
    ...
    container = ofOpenFOAMCase_turboMachine(
      ...
      dictRule = \
        ...
        fieldRules = [
          ...
          ofOpenFOAMCase_setupWrapper.fieldRuleString("k", [0.05,]),
          ofOpenFOAMCase_setupWrapper.fieldRuleString("omega", [2.0,]),
        ...
        setupRules = [
          ...
          ofOpenFOAMCase_setupWrapper.cylindricalInletRuleString(
            "mesh_inlet",
            ["U"],
            [ [-7.5,np.tan(26.8*np.pi/180)*7.5,0], ] #6.7

          ),
          ofOpenFOAMCase_setupWrapper.inletRuleString(
            "mesh_inlet",
            ["p", "k", "omega",],
            [ [0], [0.0, 0.05], [2.0, 2.0] ]#cV["QIn"]()
          ),
    ...
    dtOO.lVHOstateHandler().makeState("roskreppRunner_1_2")
...
def CreateAndShow( *args, **kwargs ):
  ...
  cc = roskreppRunner().create(*args, **kwargs)
