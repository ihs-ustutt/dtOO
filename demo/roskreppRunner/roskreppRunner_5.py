...
class roskreppRunner_5:
  ...
  def create( 
    ...
    container = rotatingMap2dTo3d_hubShroudCreate(
      "channel",
      shroudPoints = [
        dtOO.dtPoint3(2.5, 0.00, 0.860), #z: +0.04
    ...
    container = analyticSurface_threePointMeanplaneFromRatio(
        ...
        [
            ...
            dtOO.dtPoint2(0.50, (np.pi/180.) * 32.967),
            dtOO.dtPoint2(0.25, (np.pi/180.) * 22.500),#35.967),
        ...
        [
            ...
            dtOO.dtPoint2(1.00, 1.45), #shroud
            dtOO.dtPoint2(0.75, 1.75),
            dtOO.dtPoint2(0.50, 1.7),
            dtOO.dtPoint2(0.25, 1.65),
            dtOO.dtPoint2(0.00, 1.825),
    ...
    container = rotatingMap2dTo3d_hubShroudCreate(
      ...
      shroudPoints = [
        ...
        dtOO.dtPoint3(1.51, 0.00, -0.85),
        dtOO.dtPoint3(1.51, 0.00, -3.2755),
      ],
      hubPoints = [
        dtOO.dtPoint3(0.1, 0.00, -0.85),
        dtOO.dtPoint3(0.1, 0.00, -3.2755),
      ],
      order = 1,
      rotVector = dtOO.dtVector3(0, 0, 1)
    ).buildExtract( container )
    ...
    container = ofOpenFOAMCase_turboMachine(
      ...
      dictRule = \
        ...
        fieldRules = [
          ...
          ofOpenFOAMCase_setupWrapper.fieldRuleString("omega", [100.0,]),
    ...
    dtOO.lVHOstateHandler().makeState("roskreppRunner_5_2")
...
def CreateAndShow( *args, **kwargs ):
  ...
  cc = roskreppRunner_5().create(*args, **kwargs)
