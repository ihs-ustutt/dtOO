...
class roskreppRunner_2:
  ...
  def create( 
    self, 
    alpha_1_0: float = 27.465,
    alpha_1_1: float = 57.299,
    ...
    container = rotatingMap2dTo3d_hubShroudCreate(
      "channel",
      shroudPoints = [
        dtOO.dtPoint3(2.5, 0.00, 0.820),
        dtOO.dtPoint3(1.65, 0.00, 0.820),
        dtOO.dtPoint3(1.507, 0.00, 0.820),
        dtOO.dtPoint3(1.432, 0.00, 0.561),
        dtOO.dtPoint3(1.51, 0.00, 0.0),
        dtOO.dtPoint3(1.51, 0.00, -0.85),
      ],
      hubPoints = [
        dtOO.dtPoint3(2.5, 0.00, 1.740),
        dtOO.dtPoint3(1.65, 0.00, 1.740),
        dtOO.dtPoint3(1.119, 0.00, 1.740),
        dtOO.dtPoint3(0.687, 0.00, 1.581),
        dtOO.dtPoint3(0.423, 0.00, 1.320),
        dtOO.dtPoint3(0.293, 0.00, 1.098),
        dtOO.dtPoint3(0.134, 0.00, 0.784),
        dtOO.dtPoint3(0.100, 0.00, 0.000),
        dtOO.dtPoint3(0.100, 0.00, -0.850),
      ],
      order = 2,
    ...
    container = analyticSurface_threePointMeanplaneFromRatio(
        ...
        [
            ...
            dtOO.dtPoint2(0.75, (np.pi/180.) * 42.189),
            dtOO.dtPoint2(0.50, (np.pi/180.) * 42.189),
            dtOO.dtPoint2(0.25, (np.pi/180.) * 42.189),
        ...
        [
            ...
            dtOO.dtPoint2(1.00, (np.pi/180.) * 35.967),
            dtOO.dtPoint2(1.00, (np.pi/180.) * 35.967),
            dtOO.dtPoint2(1.00, (np.pi/180.) * 35.967),
        ...
        [
            dtOO.dtPoint2(1.00, 0.60), #0.00, 0.50 #shroud
            dtOO.dtPoint2(0.75, 0.60), #0.00, 0.50
            dtOO.dtPoint2(0.50, 0.60), #0.00, 0.50
            dtOO.dtPoint2(0.25, 0.70), #0.00, 0.60
            dtOO.dtPoint2(0.00, 0.80), #1.00, 0.70
        ],
        1
        )(),
        ...
        [
            ...
            dtOO.dtPoint2(1.00, 1.35), #shroud
            dtOO.dtPoint2(0.75, 1.65),
            dtOO.dtPoint2(0.50, 1.7),
            dtOO.dtPoint2(0.25, 1.75),
            dtOO.dtPoint2(0.00, 1.85),
    ...
    container = map3dTo3dGmsh_gridFromChannelAndBlocks(
      ...
      bladeHubElementSize = scaOneD_scaCurve2dOneDPointConstruct(
        [
          dtOO.dtPoint2(0.00, 0.004), #0.005 Austritt
          dtOO.dtPoint2(0.25, 0.005), #0.005
          dtOO.dtPoint2(0.50, 0.001), #0.0008
          dtOO.dtPoint2(0.75, 0.005), #0.005
          dtOO.dtPoint2(1.00, 0.004), #0.005
        ], 1
      )(),
    ...
    container = rotatingMap2dTo3d_hubShroudCreate(
      ...
      shroudPoints = [
        ...
        # dtOO.dtPoint3(0.10, 0.00, 0.820),

        # Zylindrisches Saugrohr
        dtOO.dtPoint3(1.51, 0.00, -0.85),
        dtOO.dtPoint3(1.51, 0.00, -3.2755) #-2.4255),
      ],
      hubPoints = [
        dtOO.dtPoint3(0.1, 0.00, -0.85),
        dtOO.dtPoint3(0.1, 0.00, -3.2755) #-2.4255),
      ],
      order = 1,
      rotVector = dtOO.dtVector3(0, 0, 1)
    ).buildExtract( container )
    ...
    container = ofOpenFOAMCase_turboMachine(
      ...
      dictRule = \
        ...
        fieldRules = [
          ...
          ofOpenFOAMCase_setupWrapper.fieldRuleString("k", [0.5,]),
          ofOpenFOAMCase_setupWrapper.fieldRuleString("omega", [50.0,]),
        ...
        setupRules = [
          ...
          ofOpenFOAMCase_setupWrapper.cylindricalInletRuleString(
            "mesh_inlet",
            ["U"],
            [ [-4.8438,np.tan(25.092*np.pi/180)*4.8438,0], ] #6.7

          ),
          ofOpenFOAMCase_setupWrapper.inletRuleString(
            "mesh_inlet",
            ["p", "k", "omega",],
            [ [0], [0.05, 0.5], [2.0] ]#cV["QIn"]()
          ),
    ...
    dtOO.lVHOstateHandler().makeState("roskreppRunner_2_5")
...
def CreateAndShow( *args, **kwargs ):
  ...
  cc = roskreppRunner_2().create(*args, **kwargs)
