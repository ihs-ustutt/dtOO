...
namespace dtOO {
  ...
  class map2dTo3d : public analyticGeometry {
    public:
      ...
      virtual map1dTo3d * 
      segmentConstU( float const & uu, float const & p0, float const & p1 ) const;
      virtual map1dTo3d * 
      segmentConstV( float const & vv, float const & p0, float const & p1 ) const;
      ...
      map1dTo3d * 
      segmentPercent( dtPoint2 const & p0, dtPoint2 const & p1 ) const;    
