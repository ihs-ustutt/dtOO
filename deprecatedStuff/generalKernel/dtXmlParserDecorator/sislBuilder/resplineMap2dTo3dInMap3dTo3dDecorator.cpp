#include "resplineMap2dTo3dInMap3dTo3dDecorator.h"
...
namespace dtOO {
  resplineMap2dTo3dInMap3dTo3dDecorator::resplineMap2dTo3dInMap3dTo3dDecorator() {
  }
  ...
  void resplineMap2dTo3dInMap3dTo3dDecorator::buildPart( 
    ...
    if ( hasGeos ) {
      ...
      //
      map2dTo3d const * m2d;
      dt__mustCast(aG, map2dTo3d const, m2d);
      ...
      //      
      aGeoP->push_back( m3d->reparamInVolume(m2d) );
    }
  }
}
