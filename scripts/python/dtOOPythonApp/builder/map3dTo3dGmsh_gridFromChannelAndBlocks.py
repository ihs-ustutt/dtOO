    ...
    for lines, elementSize, elementScale, outStr in zip(
      ...
      for line in lines:
        ...
        if elementSize!=None:
          ...
          #
          # a closed blade and, therefore, a periodic surface can have points 
          # that lie outside of the range [0, 1]; this is ok, but the 
          # elementSize function is only defined in the range [0, 1]; so
          # a correction is necesary
          # 
