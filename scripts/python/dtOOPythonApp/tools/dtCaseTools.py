...
class dtCaseStrategy(generalStrategy):
  @abstractmethod
  def apply(
    self,
    bC: baseContainer,
...
class dtCaseStrategyFactory:
  REGISTRY = {}

  @classmethod
  def create(self, name: str) -> dtCaseStrategy:
  ...
  def register(self, name: str) -> Callable:
    def inner_wrapper(wrapped_class: dtCaseStrategy) -> Callable:
      nameStr = name
      if nameStr=="":
...
class dtCaseComponent(ABC):
  def __init__(self, strategy: dtCaseStrategy) -> None:
    self._strategy = strategy

  @property
  def strategy(self) -> dtCaseStrategy:
    return self._strategy

  @strategy.setter
  def strategy(self, strategy: dtCaseStrategy) -> None:
    self._strategy = strategy
