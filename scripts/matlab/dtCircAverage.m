classdef dtCircAverage
   ...
   methods
      ...
      function [] = WriteCSV( obj, field, fieldLabel, formatStr )
% WriteCSV Write circumferenctial averaged field to csv file.
%   field : dtScalarField or dtVectorField
%   fieldLabel : labels of field
%   formatStr : format specifier
%   Example:
%     WriteCSV( uOut_, ...
...
%       '%16.8e' ...
%     )
%     WriteCSV( epsilonOut_, ...
%       'Turbulence Eddy Dissipation [ m^2 s^-3 ]' ...
%       '%16.8e' ...
%     )
        ...
        fprintf(...
          fileID, ...
          ['%16.8e, ', formatStr,'\n'], ...
          0.9 * obj.binRMean_(1), obj.binQ_(1,1:end) ...
        );            
        for ii=1:obj.nBins_
          fprintf(...
            fileID, ...
            ['%16.8e, ', formatStr,'\n'], ...
            obj.binRMean_(ii), obj.binQ_(ii,1:end) ...
          );          
        end
        fprintf(...
          fileID, ...
          ['%16.8e, ', formatStr,'\n'], ...
          1.1 * obj.binRMean_(end), obj.binQ_(end,1:end) ...
        );                    
        fclose(fileID);
      end
   end
