#include "vec3dTwoDTwelveRectangleAFXmlBuilder.h"
...
namespace dtOO {
  ...
  void vec3dTwoDTwelveRectangleAFXmlBuilder::buildPart(
  ...
  void vec3dTwoDTwelveRectangleAFXmlBuilder::reorder( 
...
//        dtPoint3 s1 = retVec[3]->pointPercent(1.);
	...
	analyticFunction * 
	vec3dTwoDTwelveRectangleAFXmlBuilder::createCompound( 
