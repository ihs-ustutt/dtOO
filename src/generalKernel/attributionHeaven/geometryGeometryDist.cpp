...
geometryGeometryDist::geometryGeometryDist(
  ...
  : _aG0(aG0), _aG1(aG1), _dimension(aG0->dim() + aG1->dim())
{
}

geometryGeometryDist::geometryGeometryDist(geometryGeometryDist const &orig)
  : _aG0(orig._aG0), _aG1(orig._aG1), _dimension(orig._dimension)
{
}
...
dtReal geometryGeometryDist::operator()(std::vector<dtReal> const &xx) const
{
...
dtInt const &geometryGeometryDist::dimension() const { return _dimension; }
