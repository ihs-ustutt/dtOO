...
bool geomShape_readOCCAGXmlBuilder::_registrated =
  aGXmlBuilderFactory::registrate(dt__tmpPtr(
    geomShape_readOCCAGXmlBuilder, new geomShape_readOCCAGXmlBuilder()
  ));

geomShape_readOCCAGXmlBuilder ::geomShape_readOCCAGXmlBuilder() {}

geomShape_readOCCAGXmlBuilder ::~geomShape_readOCCAGXmlBuilder() {}

std::vector<std::string> geomShape_readOCCAGXmlBuilder::factoryAlias(void) const
{
  return ::boost::assign::list_of("geomShape_readIgesOCCAGXmlBuilder")(
