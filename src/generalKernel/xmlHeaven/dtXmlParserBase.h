...
public:
  ...
  static dtPoint3
  getDtPoint3(std::string const &str, baseContainer const *const bC);
  static dtPoint3
  getDtPoint3(::QDomElement const &toBuildP, baseContainer const *const bC);
  ...
  static dtVector3
  getDtVector3(std::string const &str, baseContainer const *const bC);
  static dtVector3
  getDtVector3(::QDomElement const &toBuildP, baseContainer const *const bC);
  //
  // analyticGeometry
  //
  static void createAdvanced(
