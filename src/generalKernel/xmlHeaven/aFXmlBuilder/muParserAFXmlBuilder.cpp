...
namespace dtOO {
bool muParserAFXmlBuilder::_registrated = aFXmlBuilderFactory::registrate(
...
) const
{
  ...
  if (dtXmlParserBase::hasChild("expression", toBuildP))
  {
    ...
    expStr = dtXmlParserBase::replaceDependencies(
  ...
  if (isSca && isOneD)
  {
    ...
    scaMuParserOneD *theF = new scaMuParserOneD(
      expStr, dtXmlParserBase::getAttributeStr("name", xOneEl)
    );
    theF->setMin(
      dtXmlParserBase::getAttributeFloatMuParse("min", xOneEl, cValP, depSFunP)
    );
    theF->setMax(
      dtXmlParserBase::getAttributeFloatMuParse("max", xOneEl, cValP, depSFunP)
    );
  ...
  else if (isSca && isTwoD)
  {
    ...
    scaMuParserTwoD *theF = new scaMuParserTwoD(
      expStr,
    ...
    theF->setMin(
      1,
      dtXmlParserBase::getAttributeFloatMuParse("min", xTwoEl, cValP, depSFunP)
    );
    theF->setMax(
      0,
      dtXmlParserBase::getAttributeFloatMuParse("max", xOneEl, cValP, depSFunP)
    ...
    theF->setMax(
      1,
      dtXmlParserBase::getAttributeFloatMuParse("max", xTwoEl, cValP, depSFunP)
    );
  ...
  else if (isSca && isThreeD)
  {
    ...
    scaMuParserThreeD *theF = new scaMuParserThreeD(
      expStr,
      dtXmlParserBase::getAttributeStr("name", xOneEl),
      dtXmlParserBase::getAttributeStr("name", xTwoEl),
  ...
  else if (isVec2d && isTwoD)
  {
    ...
    vec2dMuParserTwoD *theF = new vec2dMuParserTwoD(
      expStr,
      dtXmlParserBase::getAttributeStr("name", xOneEl),
      dtXmlParserBase::getAttributeStr("name", xTwoEl)
    );
  ...
  else if (isVec3d && isOneD)
  {
    ...
    vec3dMuParserOneD *theF = new vec3dMuParserOneD(
      expStr, dtXmlParserBase::getAttributeStr("name", xOneEl)
    );
  ...
  else if (isVec3d && isTwoD)
  {
    ...
    vec3dMuParserTwoD *theF = new vec3dMuParserTwoD(
      expStr,
      dtXmlParserBase::getAttributeStr("name", xOneEl),
      dtXmlParserBase::getAttributeStr("name", xTwoEl)
    );
  ...
  else if (isVec3d && isThreeD)
  {
    ...
    vec3dMuParserThreeD *theF = new vec3dMuParserThreeD(
      expStr,
      dtXmlParserBase::getAttributeStr("name", xOneEl),
      dtXmlParserBase::getAttributeStr("name", xTwoEl),
      dtXmlParserBase::getAttributeStr("name", xThreeEl)
