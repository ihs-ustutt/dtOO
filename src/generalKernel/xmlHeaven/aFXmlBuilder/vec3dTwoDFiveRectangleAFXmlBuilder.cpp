#include "vec3dTwoDFiveRectangleAFXmlBuilder.h"
...
namespace dtOO {
  vec3dTwoDFiveRectangleAFXmlBuilder::vec3dTwoDFiveRectangleAFXmlBuilder() {
  }
...
void vec3dTwoDFiveRectangleAFXmlBuilder::reorder( 
