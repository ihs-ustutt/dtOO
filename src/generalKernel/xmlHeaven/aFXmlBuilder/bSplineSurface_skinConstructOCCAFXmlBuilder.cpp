...
bSplineSurface_skinConstructOCCAFXmlBuilder ::factoryAlias(void) const
{
  return ::boost::assign::list_of("vec3dSurfaceTwoD")(
...
) const
{
  ...
  dt__pH(dtSurface)
    dtS(bSplineSurface_skinConstructOCC(cL, minDeg, maxDeg, nIter).result());
