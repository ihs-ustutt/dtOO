...
void to_json(::nlohmann::json &to, std::vector<analyticGeometry *> const &from)
{
...
void to_json(::nlohmann::json &to, std::vector<analyticFunction *> const &from)
{
...
void to_json(::nlohmann::json &to, std::vector<boundedVolume *> const &from)
{
...
void from_json(const ::nlohmann::json &from, std::vector<constValue *> &to)
{
  if (from["constValue"].is_array())
  {
    dt__forAllRefAuto(from["constValue"], aFrom)
    {
      ...
      to.push_back(constValue::create(
        aFrom.at("name"), aFrom.at("label"), aFrom.at("value"), loadable
      ));
    }
  }
}
void to_json(::nlohmann::json &to, std::vector<constValue *> const &from)
{
...
void jsonPrimitive::write(std::string const &fname) const
{
  ...
  {
    dt__info(write(), << "File " << fname << " already exists. Skip writing");
  }
}

std::string jsonPrimitive::toStdString(void) const { return _json->dump(); }
...
{
  dt__throwIf(stringPrimitive::stringContains("|", childName), containsChild());
...
// template lookup
template <typename T> T jsonPrimitive::lookup(std::string const &str) const
{
  T ret;
  if (str.empty())
  {
...
template std::string
jsonPrimitive::lookup<std::string>(std::string const &) const;
template dtReal jsonPrimitive::lookup<dtReal>(std::string const &) const;
template dtInt jsonPrimitive::lookup<dtInt>(std::string const &) const;
template bool jsonPrimitive::lookup<bool>(std::string const &) const;
template jsonPrimitive
jsonPrimitive::lookup<jsonPrimitive>(std::string const &) const;
template dtPoint2 jsonPrimitive::lookup<dtPoint2>(std::string const &) const;
template dtVector2 jsonPrimitive::lookup<dtVector2>(std::string const &) const;
template dtPoint3 jsonPrimitive::lookup<dtPoint3>(std::string const &) const;
template dtVector3 jsonPrimitive::lookup<dtVector3>(std::string const &) const;
template std::vector<dtInt>
jsonPrimitive::lookup<std::vector<dtInt>>(std::string const &) const;
template std::vector<bool>
jsonPrimitive::lookup<std::vector<bool>>(std::string const &) const;
template std::vector<dtReal>
jsonPrimitive::lookup<std::vector<dtReal>>(std::string const &) const;
template std::vector<std::string>
jsonPrimitive::lookup<std::vector<std::string>>(std::string const &) const;
template std::vector<jsonPrimitive>
jsonPrimitive::lookup<std::vector<jsonPrimitive>>(std::string const &) const;
template std::vector<constValue *>
jsonPrimitive::lookup<std::vector<constValue *>>(std::string const &) const;
...
template dt__pH(analyticFunction) jsonPrimitive::lookupClone(
  std::string const &str,
  labeledVectorHandling<analyticFunction *> const *const ptrVec
) const;
template dt__pH(analyticGeometry) jsonPrimitive::lookupClone(
  std::string const &str,
  labeledVectorHandling<analyticGeometry *> const *const ptrVec
) const;
template dt__pH(dtTransformer) jsonPrimitive::lookupClone(
  std::string const &str,
...
template dt__pH(dtTransformer) jsonPrimitive::lookupClone(
  std::string const &str, const labeledVectorHandling<dtTransformer *> &refVec
) const;
...
template analyticFunction const *const jsonPrimitive::lookupRaw(
  std::string const &str,
  labeledVectorHandling<analyticFunction *> const *const ptrVec
) const;
...
template const analyticFunction &jsonPrimitive::lookupRef(
  std::string const &str,
  labeledVectorHandling<analyticFunction *> const *const ptrVec
) const;
...
) const
{
  std::vector<jsonPrimitive> jP =
    lookup<jsonPrimitive>(str).lookup<std::vector<jsonPrimitive>>(T::className()
    );
  dt__pVH(T) ret;
  dt__forAllRefAuto(jP, aJP)
  {
    ...
    {
      dt__forAllRefAuto(
        ptrVec->getIndices(aJP.lookup<std::string>("labels")), anInd
      )
      {
      ...
      dt__throwUnexpected(lookupVecClone());
  }
  return ret;
}
template dt__pVH(analyticGeometry) jsonPrimitive::lookupVecClone(
  std::string const &str,
  labeledVectorHandling<analyticGeometry *> const *const ptrVec
) const;
template dt__pVH(analyticFunction) jsonPrimitive::lookupVecClone(
  std::string const &str,
  labeledVectorHandling<analyticFunction *> const *const ptrVec
) const;
...
template std::vector<analyticFunction const *> jsonPrimitive::lookupVecRaw(
  std::string const &str,
  labeledVectorHandling<analyticFunction *> const *const ptrVec
) const;
template std::vector<boundedVolume const *> jsonPrimitive::lookupVecRaw(
  std::string const &str,
...
template dtReal
jsonPrimitive::lookupDef<dtReal>(std::string const &, dtReal const &def) const;
template dtInt
jsonPrimitive::lookupDef<dtInt>(std::string const &, dtInt const &def) const;
template bool
jsonPrimitive::lookupDef<bool>(std::string const &, bool const &def) const;
template dtVector3 jsonPrimitive::lookupDef<dtVector3>(
...
template ::std::vector<dtInt>
jsonPrimitive::lookupDef<::std::vector<dtInt>>(
...
jsonPrimitive::operator[]<std::string>(std::string const &) const;
template dtReal const
jsonPrimitive::operator[]<dtReal>(std::string const &) const;
template dtInt const
jsonPrimitive::operator[]<dtInt>(std::string const &) const;
template std::vector<std::string> const
jsonPrimitive::operator[]<std::vector<std::string>>(std::string const &) const;
template std::vector<dtInt> const
jsonPrimitive::operator[]<std::vector<dtInt>>(std::string const &) const;
template std::vector<dtReal> const
jsonPrimitive::operator[]<std::vector<dtReal>>(std::string const &) const;

// template append
template <typename T>
jsonPrimitive jsonPrimitive::append(std::string const &str, T const &val)
{
  if (str.empty())
  {
    to_json(*_json, val);
...
template jsonPrimitive
jsonPrimitive::append(std::string const &str, std::string const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, dtReal const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, dtInt const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, bool const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, jsonPrimitive const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, dtPoint2 const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, dtVector2 const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, dtPoint3 const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, dtVector3 const &val);
...
template jsonPrimitive
jsonPrimitive::append(std::string const &str, std::vector<bool> const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, std::vector<dtInt> const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, std::vector<dtReal> const &val);
template jsonPrimitive
jsonPrimitive::append(std::string const &str, dtTransformer const *const &val);

::nlohmann::json const &jsonPrimitive::json(void) const { return *_json; }
} // namespace dtOO
