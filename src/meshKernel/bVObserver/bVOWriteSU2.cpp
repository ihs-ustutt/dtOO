...
bool bVOWriteSU2::_registrated =
  bVOInterfaceFactory::registrate(dt__tmpPtr(bVOWriteSU2, new bVOWriteSU2()));
...
)
{
  ...
  //      _saveParametric = qtXmlBase::getAttributeBool("saveParametric",
  //      element);
  //    }
}
