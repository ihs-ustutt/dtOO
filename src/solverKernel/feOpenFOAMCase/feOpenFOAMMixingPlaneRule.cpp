...
namespace dtOO {
bool feOpenFOAMMixingPlaneRule::_registrated = feOpenFOAMSetupRule::registrate(
...
std::vector<std::string> feOpenFOAMMixingPlaneRule::factoryAlias(void) const
{
...
) const
{
  ...
  //
  ::Foam::mixingPlanePolyPatch *mix0 = new ::Foam::mixingPlanePolyPatch(
    bM[id0].name(),
    bM[id0].size(),
    bM[id0].start(),
    bM[id0].index(),
  ...
  ::Foam::mixingPlanePolyPatch *mix1 = new ::Foam::mixingPlanePolyPatch(
    bM[id1].name(),
    bM[id1].size(),
    bM[id1].start(),
    bM[id1].index(),
