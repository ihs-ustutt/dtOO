...
namespace dtOO {
bool feOpenFOAMGgiRule::_registrated = feOpenFOAMSetupRule::registrate(
...
) const
{
  ...
  //
  ::Foam::ggiPolyPatch *ggi0 = new ::Foam::ggiPolyPatch(
    bM[id0].name(),
    bM[id0].size(),
    bM[id0].start(),
    bM[id0].index(),
  ...
  ::Foam::ggiPolyPatch *ggi1 = new ::Foam::ggiPolyPatch(
    bM[id1].name(),
    bM[id1].size(),
    bM[id1].start(),
    bM[id1].index(),
