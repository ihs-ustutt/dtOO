...
bool feOpenFOAMCylindricalInletRule::_registrated =
  feOpenFOAMSetupRule::registrate(dt__tmpPtr(
...
std::vector<std::string> feOpenFOAMCylindricalInletRule::factoryAlias(void
) const
{
          ...
          stringPrimitive::stringContains("origin", thisRule))
      {
        ...
        else if (stringPrimitive::stringContains("function", thisRule))
        {
          ...
          dt__ptrAss(
            ...
            vec3dThreeD::ConstDownCast(feOpenFOAMSetupRule::refAF().get(
