...
namespace dtOO {
bool ofOpenFOAMCyclicAmiRule::_registrated = ofOpenFOAMSetupRule::registrate(
...
) const
{
  ...
  ::Foam::cyclicAMIPolyPatch *ami0 = new ::Foam::cyclicAMIPolyPatch(
    bM[id0].name(), dd0, bM[id0].index(), bM[id0].boundaryMesh(), "cyclicAMI"
  );
  ...
  ::Foam::cyclicAMIPolyPatch *ami1 = new ::Foam::cyclicAMIPolyPatch(
    bM[id1].name(), dd1, bM[id1].index(), bM[id1].boundaryMesh(), "cyclicAMI"
  );
  //
