...
namespace dtOO {
dtOCCTrimmedCurve::dtOCCTrimmedCurve() : dtOCCCurve() { _ptr = NULL; }

dtOCCTrimmedCurve::dtOCCTrimmedCurve(dtOCCCurveBase const &orig)
  : dtOCCCurve(orig)
{
...
dtInt dtOCCTrimmedCurve::order(void) const { dt__throwUnexpected(order()); }

dtInt dtOCCTrimmedCurve::nControlPoints(void) const { return 0; }
