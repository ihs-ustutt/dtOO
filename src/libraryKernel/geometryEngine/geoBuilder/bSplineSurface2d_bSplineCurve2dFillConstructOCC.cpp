  ...
  )
{
  ...
  {
    dt__ptrAss(
      dtOCCCurve2d const *occC2d, dtOCCCurve2d::ConstDownCast(cc2d[ii])
    );
  ...
  dt__pH(dtSurface)
    dtS(bSplineSurface_bSplineCurveFillConstructOCC(cc).result());
  dt__ptrAss(
    dtOCCSurface const *occS, dtOCCBSplineSurface::ConstDownCast(dtS.get())
  );
