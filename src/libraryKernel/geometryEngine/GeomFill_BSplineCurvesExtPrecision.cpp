...
#include "GeomFill_BSplineCurvesExtPrecision.h"
...
//=======================================================================
//function : GeomFill_BSplineCurvesExtPrecision
//purpose  : 
//=======================================================================

GeomFill_BSplineCurvesExtPrecision::GeomFill_BSplineCurvesExtPrecision()
{
}
...
void  GeomFill_BSplineCurvesExtPrecision::Init
  (const Handle(Geom_BSplineCurve)& C1, 
   const Handle(Geom_BSplineCurve)& C2, 
   const Handle(Geom_BSplineCurve)& C3, 
   const Handle(Geom_BSplineCurve)& C4, 
   ...
   Standard_Real Tol				)
{
  ...
  Standard_ConstructionError_Raise_if 
    (!IsOK, " GeomFill_BSplineCurvesExtPrecision: Courbes non jointives");
  ...
  if(Type == GeomFill_CoonsStyle) {
    Standard_ConstructionError_Raise_if 
      (NbUPoles < 4 || NbVPoles < 4, " GeomFill_BSplineCurvesExtPrecision: invalid filling style");
  }
