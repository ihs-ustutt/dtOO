...
namespace dtOO {
dtOCCEllipse::dtOCCEllipse() : dtOCCCurve() { _ptr = NULL; }
...
dtInt dtOCCEllipse::order(void) const { dt__throwUnexpected(order()); }

dtInt dtOCCEllipse::nControlPoints(void) const { return 0; }
