...
dtInt dtOCCGeomFillBoundary::order(void) const { dt__throwUnexpected(order()); }
...
dtInt dtOCCGeomFillBoundary::nControlPoints(void) const { return 0; }
...
void dtOCCGeomFillBoundary::setControlPoint(
...
void dtOCCGeomFillBoundary::revert(void) { dt__throwUnexpected(revert()); }
...
dtOCCGeomFillBoundaryBase const &dtOCCGeomFillBoundary::OCCBoundaryRef(void
) const
{
