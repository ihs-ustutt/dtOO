...
namespace dtOO {				
  ...
  float dtOCCGeomFillSimpleBound::minPara( int const & dir ) const {
  ...
  float dtOCCGeomFillSimpleBound::maxPara( int const & dir ) const {
  ...
  dtPoint3 dtOCCGeomFillSimpleBound::point( float const uu ) const {
