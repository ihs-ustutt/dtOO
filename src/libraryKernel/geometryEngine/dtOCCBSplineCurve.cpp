...
namespace dtOO {
dtOCCBSplineCurve::dtOCCBSplineCurve() : dtOCCCurve() { _ptr = NULL; }

dtOCCBSplineCurve::dtOCCBSplineCurve(dtOCCCurveBase const &orig)
  : dtOCCCurve(orig)
{
...
void dtOCCBSplineCurve::setControlPoint(
