...
namespace dtOO {
dtOCCBezierCurve::dtOCCBezierCurve() : dtOCCCurve() { _ptr = NULL; }

dtOCCBezierCurve::dtOCCBezierCurve(dtOCCCurveBase const &orig)
  : dtOCCCurve(orig)
{
...
void dtOCCBezierCurve::setControlPoint(dtInt const nPoint, dtPoint3 const point)
{
