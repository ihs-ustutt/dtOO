...
// optional overload
//
dtReal dtCurve2d::minU(void) const { return minPara(0); }

dtReal dtCurve2d::maxU(void) const { return maxPara(0); }
...
dtReal dtCurve2d::length(void) const { return l_u(maxPara(0)); }
