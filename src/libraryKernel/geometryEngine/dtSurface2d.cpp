...
dtReal dtSurface2d::minU(void) const { return minPara(0); }

dtReal dtSurface2d::maxU(void) const { return maxPara(0); }

dtReal dtSurface2d::minV(void) const { return minPara(1); }

dtReal dtSurface2d::maxV(void) const { return maxPara(1); }

bool dtSurface2d::closedU(void) const { return closed(0); }

bool dtSurface2d::closedV(void) const { return closed(1); }
...
int dtSurface2d::nControlPointsU(void) const { return nControlPoints(0); }

int dtSurface2d::nControlPointsV(void) const { return nControlPoints(1); }
