...
namespace dtOO {
bool dtMeshLaplacianGFace::_registrated = dtMeshOperatorFactory::registrate(
...
dtMeshLaplacianGFace::dtMeshLaplacianGFace(const dtMeshLaplacianGFace &orig)
...
void dtMeshLaplacianGFace::operator()(dtGmshFace *dtgf)
{
  ...
  dt__forInnerIndex(pUV, ii)
  {
    ...
    {
      pUV[ii][jj] = dtLinearAlgebra::intersectionPoint(
        dtLine2(pUV[ii][0], pUV[ii][H]), dtLine2(pUV[0][jj], pUV[L][jj])
      );
    }
  }
