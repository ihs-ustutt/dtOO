...
public:
  ...
  cast2DtGmshRegion(std::list<::GRegion *> regions);
  static std::list<dtGmshRegion *>
  ...
  static std::vector<dtGmshVertex *>
  cast2DtGmshVertex(std::vector<::GVertex *> vertices);
  //
  ...
  // add region
  //
  void addIfRegionToGmshModel(map3dTo3d const *const region, dtInt *const tag);
  ...
  dtInt addIfRegionToGmshModel(map3dTo3d const *const region);
  ...
  static unstructured3dMesh *
  toUnstructured3dMesh(std::vector<::MElement const *> const &elements);
...
private:
  ...
  static discrete3dPoints *
  toDiscrete3dPoints(std::vector<::MVertex const *> const &vertices);
