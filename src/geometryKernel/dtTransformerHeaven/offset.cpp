...
bool offset::_registrated =
  dtTransformerFactory::registrate(dt__tmpPtr(offset, new offset()));
...
dtTransformer *offset::clone(void) const { return new offset(*this); }

dtTransformer *offset::create(void) const { return new offset(); }

lvH_analyticGeometry offset::apply(lvH_analyticGeometry const *const toTrans
) const
{
  ...
  dt__forAllRefAuto(*toTrans, aTrans)
  {
    ...
    {
      analyticSurface *aS = analyticSurface::MustConstDownCast(aTrans)->clone();
...
lvH_analyticFunction offset::apply(lvH_analyticFunction const *const toTrans
) const
{
  ...
  dt__forAllRefAuto(*toTrans, aTrans)
  {
    scaCurve2dOneD *s2d = scaCurve2dOneD::MustConstDownCast(aTrans)->clone();
    //
    // translation vector
    //
    dtVector2 transVec;
    if (_xyPercent == true)
    {
      ...
      dtReal yRange = s2d->YFloat(s2d->xMax(0)) - s2d->YFloat(s2d->xMin(0));
...
bool offset::isNecessary(void) const { return true; }
...
)
{
  ...
  if (dtXmlParserBase::hasAttribute("parameter_one_offset_percent", *tE))
  {
    _paraOneOffsetPercent =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("parameter_one_offset_percent", *tE),
        cV,
        aF
      ));
  }
  if (dtXmlParserBase::hasAttribute("parameter_two_offset_percent", *tE))
  {
    _paraTwoOffsetPercent =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("parameter_two_offset_percent", *tE),
        cV,
        aF
      ));
  }
  if (dtXmlParserBase::hasAttribute("number_pieces", *tE))
  {
    _nPieces =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("number_pieces", *tE), cV, aF
      ));
  }
  if (dtXmlParserBase::hasAttribute("x_offset_percent", *tE))
  {
    _xOffset =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("x_offset_percent", *tE), cV, aF
      ));
    _xyPercent = true;
  }
  if (dtXmlParserBase::hasAttribute("y_offset_percent", *tE))
  {
    _yOffset =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("y_offset_percent", *tE), cV, aF
      ));
    _xyPercent = true;
  }
  if (dtXmlParserBase::hasAttribute("x_offset", *tE))
  {
    _xOffset =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("x_offset", *tE), cV, aF
      ));
  }
  if (dtXmlParserBase::hasAttribute("y_offset", *tE))
  {
    _yOffset =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("y_offset", *tE), cV, aF
      ));
  }
  if (dtXmlParserBase::hasAttribute("normal_offset", *tE))
  {
    _normalOffset =
      dtXmlParserBase::muParseString(dtXmlParserBase::replaceDependencies(
        dtXmlParserBase::getAttributeStr("normal_offset", *tE), cV, aF
      ));
  }
