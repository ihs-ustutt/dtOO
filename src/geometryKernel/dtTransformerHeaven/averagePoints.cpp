...
namespace dtOO {
bool averagePoints::_registrated = dtTransformerFactory::registrate(
...
dtTransformer *averagePoints::create(void) const { return new averagePoints(); }
...
bool averagePoints::isNecessary(void) const { return true; }
