...
pickMap2dTo3dRectanglePercent::pickMap2dTo3dRectanglePercent() : dtTransformer()
{
}
...
pickMap2dTo3dRectanglePercent::apply(lvH_analyticGeometry const *const aGeoVecP
) const
{
  ...
  {
    aGeoRet.push_back(map2dTo3d::MustConstDownCast(aG)->segmentRectanglePercent(
...
bool pickMap2dTo3dRectanglePercent::isNecessary(void) const { return true; }
