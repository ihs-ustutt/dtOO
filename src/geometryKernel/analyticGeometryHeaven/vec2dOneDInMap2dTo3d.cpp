...
vec2dOneDInMap2dTo3d::vec2dOneDInMap2dTo3d(
  vec2dOneD const *const v2d1d, map2dTo3d const *const m2d, bool const &percentF
)
  : map1dTo3d()
{
  _v2d.reset(v2d1d->clone());
...
vec2dOneDInMap2dTo3d::vec2dOneDInMap2dTo3d(const vec2dOneDInMap2dTo3d &orig)
  : map1dTo3d(orig)
{
...
vec2dOneDInMap2dTo3d::cloneTransformed(dtTransformer const *const dtT) const
{
...
bool vec2dOneDInMap2dTo3d::isPercent(void) const { return _percentF; }
} // namespace dtOO
