...
rotatingMap2dTo3d::rotatingMap2dTo3d(const rotatingMap2dTo3d &orig)
  : map3dTo3d(orig)
{
...
rotatingMap2dTo3d *
rotatingMap2dTo3d::cloneTransformed(dtTransformer const *const dtT) const
{
...
map2dTo3d *rotatingMap2dTo3d::segmentConstU(dtReal const &uu) const
{
  ...
  {
    dt__pH(dtSurface)
      dtS(geomSurface_surfaceRotateConstructOCC(
...
map2dTo3d *rotatingMap2dTo3d::segmentConstV(dtReal const &vv) const
{
  ...
  if (aS)
  {
    ...
    dt__pH(dtSurface) dtS(surfaceOfRevolution_curveRotateConstructOCC(
...
dtVector3 const &rotatingMap2dTo3d::rotationAxis(void) const { return _vv; }

dtPoint3 const &rotatingMap2dTo3d::origin(void) const { return _pp; }
} // namespace dtOO
