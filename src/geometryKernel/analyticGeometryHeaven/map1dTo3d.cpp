...
dtInt map1dTo3d::dim(void) const { return 1; }
...
dtReal map1dTo3d::getUMin(void) const { return getMin(0); }

dtReal map1dTo3d::getUMax(void) const { return getMax(0); }

dtReal map1dTo3d::length(void) const { return l_u(getUMax()); }
...
dtReal map1dTo3d::l_u(dtReal const &uu) const { return l_u(uu, 20); }
...
map1dTo3d *new_clone(map1dTo3d const &m1d) { return m1d.clone(); }
} // namespace dtOO
