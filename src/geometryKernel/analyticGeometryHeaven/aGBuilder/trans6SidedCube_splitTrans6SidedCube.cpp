...
namespace dtOO {
trans6SidedCube_splitTrans6SidedCube ::trans6SidedCube_splitTrans6SidedCube(
...
)
{
  ...
  {
    if ((splitPoint[i] == 0.) || (splitPoint[i] == 1.))
      keep[i] = true;
  }
  dt__throwIf(
  ...
  if (keep[0] == false)
  {
    dt__pH(analyticCurve) e0(analyticCurve::MustDownCast(
      t6->constRefMap2dTo3d()[0]->segmentConstUPercent(splitPoint.x())
    ));
    dt__pH(analyticCurve) e2(analyticCurve::MustDownCast(
      t6->constRefMap2dTo3d()[2]->segmentConstUPercent(splitPoint.x())
    ));
    dt__pH(analyticCurve) e4(analyticCurve::MustDownCast(
      t6->constRefMap2dTo3d()[4]->segmentConstUPercent(splitPoint.x())
    ));
    dt__pH(analyticCurve) e5(analyticCurve::MustDownCast(
      t6->constRefMap2dTo3d()[5]->segmentConstUPercent(splitPoint.x())
    ));
    dt__pH(analyticSurface) splitFace(new analyticSurface(
      dt__pH(dtSurface)(bSplineSurface_geomCurveFillConstructOCC(
                          e2->ptrConstDtCurve(),
                          e5->ptrConstDtCurve(),
                          e0->ptrConstDtCurve(),
                          e4->ptrConstDtCurve()
    ...
    // 2
    dt__pH(analyticSurface) f2_0(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[2]->segmentRectanglePercent(
        dtPoint2(0, 0), dtPoint2(splitPoint.x(), 1)
      )
    ));
    dt__pH(analyticSurface) f2_1(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[2]->segmentRectanglePercent(
        dtPoint2(splitPoint.x(), 0), dtPoint2(1, 1)
      )
    ));
    // 0
    dt__pH(analyticSurface) f0_0(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[0]->segmentRectanglePercent(
        dtPoint2(0, 0), dtPoint2(splitPoint.x(), 1)
      )
    ));
    dt__pH(analyticSurface) f0_1(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[0]->segmentRectanglePercent(
        dtPoint2(splitPoint.x(), 0), dtPoint2(1, 1)
      )
    ));
    // 4
    dt__pH(analyticSurface) f4_0(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[4]->segmentRectanglePercent(
        dtPoint2(0, 0), dtPoint2(splitPoint.x(), 1)
      )
    ));
    dt__pH(analyticSurface) f4_1(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[4]->segmentRectanglePercent(
        dtPoint2(splitPoint.x(), 0), dtPoint2(1, 1)
      )
    ));
    // 5
    dt__pH(analyticSurface) f5_0(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[5]->segmentRectanglePercent(
        dtPoint2(0, 0), dtPoint2(splitPoint.x(), 1)
      )
    ));
    dt__pH(analyticSurface) f5_1(analyticSurface::MustDownCast(
      t6->constRefMap2dTo3d()[5]->segmentRectanglePercent(
        dtPoint2(splitPoint.x(), 0), dtPoint2(1, 1)
      )
    ));
    ...
    _t6.push_back(new trans6SidedCube(
      f0_0.get(),
      t6->constRefMap2dTo3d()[1],
      f2_0.get(),
      splitFace.get(),
      f4_0.get(),
      f5_0.get()
...
vectorHandling<trans6SidedCube *>
trans6SidedCube_splitTrans6SidedCube ::result(void)
{
...
vectorHandling<analyticGeometry *>
trans6SidedCube_splitTrans6SidedCube ::resultGeometries(void)
{
