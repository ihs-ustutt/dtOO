...
{
  gslMinFloatAttr md(
    dt__pH(pointGeometryOneDDist)(new pointGeometryOneDDist(value, m1d, dir)),
    initGuess,
    0.01,
  ...
  dt__info(
    ...
    << " ) should have " << value << " at cartesian direction " << dir << "."
    << std::endl
...
dtReal float_map1dTo3dPointConstCartesian::result(void) { return _u; }
} // namespace dtOO
