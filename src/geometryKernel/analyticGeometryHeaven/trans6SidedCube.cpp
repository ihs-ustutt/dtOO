...
trans6SidedCube *
trans6SidedCube::cloneTransformed(dtTransformer const *const dtT) const
{
...
vectorHandling<map2dTo3d const *> const &trans6SidedCube::constRefMap2dTo3d(void
) const
{
...
{
  _tI.reset(new transIntCube(
    dt__pH(analyticSurface)(
      new analyticSurface(
        dt__pH(dtSurface)(
          geomSurface_surfaceReverseConstructOCC(
            analyticSurface::MustConstDownCast(_tI->getConstRefToMap2dTo3d()[0])
              ->ptrConstDtSurface(),
            true,
            false
          )
    ...
    dt__pH(analyticSurface)(
      new analyticSurface(
        dt__pH(dtSurface)(
          geomSurface_surfaceReverseConstructOCC(
            analyticSurface::MustConstDownCast(_tI->getConstRefToMap2dTo3d()[2])
              ->ptrConstDtSurface(),
            true,
            false
          )
    ...
    dt__pH(analyticSurface)(
      new analyticSurface(
        dt__pH(dtSurface)(
          geomSurface_surfaceReverseConstructOCC(
            analyticSurface::MustConstDownCast(_tI->getConstRefToMap2dTo3d()[4])
              ->ptrConstDtSurface(),
            true,
            false
          )
    ...
    dt__pH(analyticSurface)(
      new analyticSurface(
        dt__pH(dtSurface)(
          geomSurface_surfaceReverseConstructOCC(
            analyticSurface::MustConstDownCast(_tI->getConstRefToMap2dTo3d()[5])
              ->ptrConstDtSurface(),
            true,
            false
          )
  ...
  _tI.reset(new transIntCube(
    ...
    dt__pH(analyticSurface)(
      new analyticSurface(
        dt__pH(dtSurface)(
          geomSurface_surfaceReverseConstructOCC(
            analyticSurface::MustConstDownCast(_tI->getConstRefToMap2dTo3d()[1])
              ->ptrConstDtSurface(),
            true,
            false
          )
    ...
    dt__pH(analyticSurface)(
      new analyticSurface(
        dt__pH(dtSurface)(
          geomSurface_surfaceReverseConstructOCC(
            analyticSurface::MustConstDownCast(_tI->getConstRefToMap2dTo3d()[3])
              ->ptrConstDtSurface(),
            true,
            false
          )
