...
multipleBoundedVolume::multipleBoundedVolume(const multipleBoundedVolume &orig)
...
multipleBoundedVolume *multipleBoundedVolume::create(void) const
{
...
dtInt multipleBoundedVolume::dim(void) const { return 3; }
...
dtPoint3 multipleBoundedVolume::getPoint(dtReal const *const uvw) const
{
...
analyticGeometry const *const multipleBoundedVolume::regionConstPtr(void) const
{
  return _m3d.get();
}
} // namespace dtOO
