...
//! Volume generated by translating a surface along a vector-defined axis.
...
public:
  ...
  //! Return the generating surface.
  map2dTo3d const &constRefMap2dTo3d(void) const;
  //! Return the translation vector spanning the first volume direction.
