...
rotatingMap1dTo3d::rotatingMap1dTo3d(const rotatingMap1dTo3d &orig)
  : map2dTo3d(orig)
{
...
rotatingMap1dTo3d *
rotatingMap1dTo3d::cloneTransformed(dtTransformer const *const dtT) const
{
...
dtPoint3 rotatingMap1dTo3d::getPoint(dtReal const &uu, dtReal const &vv) const
{
