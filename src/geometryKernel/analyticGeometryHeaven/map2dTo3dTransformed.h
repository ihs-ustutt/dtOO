...
template <typename funT> map2dTo3dTransformed<funT>::~map2dTo3dTransformed() {}
...
template <typename funT>
map2dTo3dTransformed<funT> *
map2dTo3dTransformed<funT>::cloneTransformed(dtTransformer const *const dtT
) const
{
...
template <typename funT>
dtPoint3
map2dTo3dTransformed<funT>::getPoint(dtReal const &uu, dtReal const &vv) const
{
...
template <typename funT>
vectorHandling<renderInterface *> map2dTo3dTransformed<funT>::getExtRender(void
) const
{
...
template <typename funT>
dtVector3
map2dTo3dTransformed<funT>::normal(dtReal const &uu, dtReal const &vv) const
{
...
map2dTo3dTransformed<funT>::firstDer(dtReal const &uu, dtReal const &vv) const
{
...
template <typename funT>
std::vector<dtVector3>
map2dTo3dTransformed<funT>::secondDer(dtReal const &uu, dtReal const &vv) const
{
  return _dtT->apply(funT::secondDer(uu, vv));
}

template <typename funT>
dtPoint2 map2dTo3dTransformed<funT>::reparamOnFace(dtPoint3 const &ppXYZ) const
{
