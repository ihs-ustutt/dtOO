...
partRotatingMap2dTo3d::partRotatingMap2dTo3d(const partRotatingMap2dTo3d &orig)
...
partRotatingMap2dTo3d::cloneTransformed(dtTransformer const *const dtT) const
{
...
map2dTo3d *partRotatingMap2dTo3d::segmentConstV(dtReal const &vv) const
{
  ...
  {
    dt__pH(analyticCurve) s3d(analyticCurve::SecureCast(
      analyticSurface::ConstDownCast(rotatingMap2dTo3d::constPtrMap2dTo3d())
    ...
    return new analyticRotatingMap1dTo3d(
      *dt__pH(dtSurface)(rectangularTrimmedSurface_curveRotateConstructOCC(
                           *dt__pH(dtCurve)(geomCurve_curveRotateConstructOCC(
                                              s3d->ptrConstDtCurve(),
                                              origin(),
                                              rotationAxis(),
                                              2.0 * M_PI * _minB
