...
template <typename funT>
analyticFunctionTransformed<funT>::analyticFunctionTransformed(funT const &orig)
  : funT(orig)
{
}
...
template <typename funT>
analyticFunctionTransformed<funT> *analyticFunctionTransformed<funT>::clone(void
) const
{
