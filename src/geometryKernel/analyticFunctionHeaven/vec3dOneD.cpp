...
int vec3dOneD::xDim(void) const { return 1; }

aFY vec3dOneD::Y(dtReal const &xx) const { return Y(xx); }
...
dtReal vec3dOneD::xMin(dtInt const &dir) const
{
  ...
  case 0:
    ...
    break;
  default:
    dt__throw(xMin(), << dt__eval(dir) << std::endl << "dir should be 0.");
  }
}
...
dtReal vec3dOneD::xMax(dtInt const &dir) const
{
  ...
  case 0:
    ...
    break;
  default:
    dt__throw(xMax(), << dt__eval(dir) << std::endl << "dir should be 0.");
  }
}

void vec3dOneD::setMin(dtReal const &min) { _min = min; }

void vec3dOneD::setMax(dtReal const &max) { _max = max; }
...
void vec3dOneD::setMin(int const &dir, dtReal const &min)
{
  ...
  case 0:
    ...
    break;
  default:
    dt__throw(setMin(), << dt__eval(dir) << std::endl << "dir should be 0.");
  }
}
...
void vec3dOneD::setMax(int const &dir, dtReal const &max)
{
  ...
  case 0:
    ...
    break;
  default:
    dt__throw(setMax(), << dt__eval(dir) << std::endl << "dir should be 0.");
  }
}
...
dtReal vec3dOneD::length(void) const { return length(xMax(0)); }
