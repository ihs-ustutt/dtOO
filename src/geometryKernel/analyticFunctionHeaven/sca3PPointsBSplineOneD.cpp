...
namespace dtOO {
  ...
  sca3PPointsBSplineOneD * sca3PPointsBSplineOneD::clone( void ) const {
	...
	sca3PPointsBSplineOneD * sca3PPointsBSplineOneD::cloneTransformed( 
    dtTransformer const * const dtT 
  ) const {
		return 
      new analyticFunctionTransformed< sca3PPointsBSplineOneD >(*this, dtT);
	}  
  ...
  dtInt sca3PPointsBSplineOneD::nDOF( void ) const {
    return 2;
  }
  
  void sca3PPointsBSplineOneD::setDOF( 
