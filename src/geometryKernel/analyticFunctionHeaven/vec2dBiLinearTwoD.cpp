...
vec2dBiLinearTwoD::vec2dBiLinearTwoD(vec2dBiLinearTwoD const &orig)
  : vec2dTwoD(orig)
{
  _p0 = orig._p0;
  _p1 = orig._p1;
...
vec2dBiLinearTwoD::vec2dBiLinearTwoD(dtPoint2 const &p0, dtPoint2 const &p2)
  : vec2dBiLinearTwoD(
...
aFY vec2dBiLinearTwoD::Y(aFX const &xx) const
{
  ...
  dtVector2 vY(
    _v0 * (1. - uu) * (1. - vv) + _v1 * uu * (1. - vv) + _v3 * (1. - uu) * vv +
    _v2 * uu * vv
  );
...
vec2dBiLinearTwoD *
vec2dBiLinearTwoD::cloneTransformed(dtTransformer const *const dtT) const
{
