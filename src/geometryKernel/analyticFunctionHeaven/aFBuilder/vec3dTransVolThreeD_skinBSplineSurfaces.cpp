  ...
  )
{
  ...
  {
    sL.push_back(vec3dSurfaceTwoD::MustConstDownCast(anAF)->constPtrDtSurface()
    );
  }
  ...
  ptrHandling<dtSurface> sL0(bSplineSurface_skinConstructOCC(cL0).result());
  ptrHandling<dtSurface> sL1(bSplineSurface_skinConstructOCC(cL1).result());
  ptrHandling<dtSurface> sL2(bSplineSurface_skinConstructOCC(cL2).result());
  ptrHandling<dtSurface> sL3(bSplineSurface_skinConstructOCC(cL3).result());
  ...
  //
  _vT.reset(new vec3dTransVolThreeD(
    v3d2d0.get(),
    v3d2d1.get(),
    v3d2d2.get(),
    v3d2d3.get(),
