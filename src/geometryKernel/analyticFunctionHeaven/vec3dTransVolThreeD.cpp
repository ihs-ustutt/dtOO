...
vec3dTransVolThreeD::vec3dTransVolThreeD(const vec3dTransVolThreeD &orig)
  : vec3dThreeD(orig)
{
  ...
  _v3dTwoD_1_0_0 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[1].YdtPoint3Percent(0., 0.));
  _v3dTwoD_1_0_1 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[1].YdtPoint3Percent(0., 1.));
  _v3dTwoD_1_1_0 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[1].YdtPoint3Percent(1., 0.));
  _v3dTwoD_1_1_1 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[1].YdtPoint3Percent(1., 1.));
  _v3dTwoD_3_0_0 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[3].YdtPoint3Percent(0., 0.));
  _v3dTwoD_3_0_1 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[3].YdtPoint3Percent(0., 1.));
  _v3dTwoD_3_1_0 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[3].YdtPoint3Percent(1., 0.));
  _v3dTwoD_3_1_1 =
    dtLinearAlgebra::toDtVector3(_v3dTwoD[3].YdtPoint3Percent(1., 1.));
}
...
aFY vec3dTransVolThreeD::Y(aFX const &xx) const
{
  ...
  dtVector3 rV =
    ...
    (1. - x0) *
      ((1. - x1) * ((1. - x2) * _v3dTwoD_1_0_0 + x2 * _v3dTwoD_1_0_1) +
       x1 * ((1. - x2) * _v3dTwoD_1_1_0 + x2 * _v3dTwoD_1_1_1)) +
    x0 * ((1. - x1) * ((1. - x2) * _v3dTwoD_3_0_0 + x2 * _v3dTwoD_3_0_1) +
          x1 * ((1. - x2) * _v3dTwoD_3_1_0 + x2 * _v3dTwoD_3_1_1));
...
vec3dTransVolThreeD *
vec3dTransVolThreeD::cloneTransformed(dtTransformer const *const dtT) const
{
 ...
 */
bool vec3dTransVolThreeD::closed(dtInt const &dir) const { return false; }
} // namespace dtOO
