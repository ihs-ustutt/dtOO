...
//! Scalar three-variable expression evaluated by muParser.
...
public:
   ...
   * @param argThree Name of the third expression variable.
   */
  scaMuParserThreeD(
  ...
  virtual scaMuParserThreeD *cloneTransformed(dtTransformer const *const dtT
  ) const;
  scaMuParserThreeD *create(void) const;
  virtual ~scaMuParserThreeD();
  virtual dtReal
  YFloat(dtReal const &x0, dtReal const &x1, dtReal const &x2) const;
