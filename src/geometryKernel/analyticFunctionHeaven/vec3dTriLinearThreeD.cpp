...
vec3dTriLinearThreeD::vec3dTriLinearThreeD(vec3dTriLinearThreeD const &orig)
  : vec3dThreeD(orig)
{
  _v000 = orig._v000;
  _v100 = orig._v100;
...
std::pair<aFY, aFY> vec3dTriLinearThreeD::yBoundingBox(void) const
{
  std::pair<dtPoint3, dtPoint3> bBox =
    dtLinearAlgebra::boundingBox(std::vector<dtPoint3>(
...
vec3dTriLinearThreeD *
vec3dTriLinearThreeD::cloneTransformed(dtTransformer const *const dtT) const
{
