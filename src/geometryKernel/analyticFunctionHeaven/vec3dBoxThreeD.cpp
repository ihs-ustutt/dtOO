...
vec3dBoxThreeD::vec3dBoxThreeD(dtPoint3 const &p0, dtPoint3 const &p1)
  : vec3dThreeD()
{
  _p0 = p0;
  _p1 = p1;
...
aFY vec3dBoxThreeD::Y(aFX const &xx) const
{
  ...
  dtPoint3 rV = _p0 + dtLinearAlgebra::unitNormal0 * (_p1.x() - _p0.x()) * x0 +
...
vec3dBoxThreeD *vec3dBoxThreeD::cloneTransformed(dtTransformer const *const dtT
) const
{
 ...
 */
bool vec3dBoxThreeD::closed(dtInt const &dir) const { return false; }
} // namespace dtOO
