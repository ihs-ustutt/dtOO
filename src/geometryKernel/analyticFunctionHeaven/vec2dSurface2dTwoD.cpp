...
vec2dSurface2dTwoD::vec2dSurface2dTwoD(const vec2dSurface2dTwoD &orig)
  : vec2dTwoD(orig)
{
...
vec2dSurface2dTwoD::vec2dSurface2dTwoD(dtSurface2d const *const dtS2d)
  : vec2dTwoD()
{
...
vec2dSurface2dTwoD *
vec2dSurface2dTwoD::cloneTransformed(dtTransformer const *const dtT) const
{
