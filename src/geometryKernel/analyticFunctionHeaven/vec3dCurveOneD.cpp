...
vec3dCurveOneD *vec3dCurveOneD::cloneTransformed(dtTransformer const *const dtT
) const
{
...
dtCurve *vec3dCurveOneD::ptrDtCurve(void) const { return _dtC.get(); }
...
bool vec3dCurveOneD::closed(dtInt const &dir) const { return _dtC->closed(); }
} // namespace dtOO
