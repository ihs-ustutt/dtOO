...
template <typename funT, typename invFunT>
analyticFunctionCombination<funT, invFunT>::analyticFunctionCombination()
{
}
...
analyticFunctionCombination<funT, invFunT>::clone(void) const
{
...
{
  return new analyticFunctionTransformed<
    analyticFunctionCombination<funT, invFunT>>(*this, dtT);
}
...
template <typename funT, typename invFunT>
aFY analyticFunctionCombination<funT, invFunT>::Y(aFX const &xx) const
{
  return _fun->Y(xx);
}

template <typename funT, typename invFunT>
aFX analyticFunctionCombination<funT, invFunT>::invY(aFY const &yy) const
{
  return _invFun->Y(analyticFunction::aFX_aFY(yy));
}

template <typename funT, typename invFunT>
bool analyticFunctionCombination<funT, invFunT>::closed(dtInt const &dir) const
{
