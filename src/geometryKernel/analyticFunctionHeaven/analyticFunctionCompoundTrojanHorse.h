...
analyticFunctionCompoundTrojanHorse<funT>::analyticFunctionCompoundTrojanHorse()
{
  _vec = NULL;
  _pos_tag = NULL;
}
...
template <typename funT>
funT *analyticFunctionCompoundTrojanHorse<funT>::component(dtInt const &pos
) const
{
...
template <typename funT>
funT *
analyticFunctionCompoundTrojanHorse<funT>::addComponent(funT const *const toAdd)
{
...
template <typename funT>
funT *analyticFunctionCompoundTrojanHorse<funT>::addComponent(
  funT const *const toAdd, dtInt const &tag
)
{
...
template <typename funT>
funT *
analyticFunctionCompoundTrojanHorse<funT>::componentFromTag(dtInt const &tag
) const
{
...
template <typename funT>
bool analyticFunctionCompoundTrojanHorse<funT>::hasTag(dtInt const &tag) const
{
  return (_pos_tag->find(tag) != _pos_tag->end());
}

template <typename funT>
funT const *analyticFunctionCompoundTrojanHorse<funT>::constRefPtr(void) const
{
  return _refPtr;
}
} // namespace dtOO
