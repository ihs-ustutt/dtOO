...
vec3dCurve2dInSurfaceOneD::vec3dCurve2dInSurfaceOneD(
  const vec3dCurve2dInSurfaceOneD &orig
)
  : vec3dOneD(orig)
{
...
vec3dCurve2dInSurfaceOneD::cloneTransformed(dtTransformer const *const dtT
) const
{
...
vectorHandling<renderInterface *> vec3dCurve2dInSurfaceOneD::getRender(void
) const
{
