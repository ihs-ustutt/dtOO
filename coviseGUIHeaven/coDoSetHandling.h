...
namespace dtOO {
  ...
  class coDoSetHandling : public vectorHandling< renderInterface * > {
    public:
      ...
      static covise::coDoSet * createCoDoSet( 
    ...
    private:
      ...
      static covise::coDoSet * renderElement3d( 
        renderInterface const * const rI, char const * const str
      );
      static covise::coDoSet * discrete2dPointsToCoDoSet( 
        discrete2dPoints const * const rI, char const * str 
      );
      static covise::coDoSet * discrete3dPointsToCoDoSet( 
        discrete3dPoints const * const rI, char const * str 
      );
      static covise::coDoSet * solid2dLineToCoDoSet( 
        solid2dLine const * const rI, char const * str 
      );
      static covise::coDoSet * solid3dLineToCoDoSet( 
        solid3dLine const * const rI, char const * str 
      );
      static covise::coDoSet * solid3dSurfaceToCoDoSet( 
        solid3dSurface const * const rI, char const * str 
      );
      static covise::coDoSet * unstructured3dMeshToCoDoSet( 
        unstructured3dMesh const * const rI, char const * str 
      );
      static covise::coDoSet * unstructured3dSurfaceMeshToCoDoSet( 
        unstructured3dSurfaceMesh const * const rI, char const * str 
      );
      static covise::coDoSet * discrete3dVectorToCoDoSet( 
