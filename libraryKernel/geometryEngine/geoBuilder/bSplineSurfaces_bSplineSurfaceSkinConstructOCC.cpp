...
namespace dtOO {
  bSplineSurfaces_bSplineSurfaceSkinConstructOCC::bSplineSurfaces_bSplineSurfaceSkinConstructOCC( 
	...
	vectorHandling< dtSurface * > bSplineSurfaces_bSplineSurfaceSkinConstructOCC::result( void ) {
		return _dtS;
	}
}
