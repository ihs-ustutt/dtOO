...
IF( NOT MOAB_FOUND STREQUAL TRUE )
  set( _incsearchpath ${DTOO_EXTERNLIBS}/moab/include/ )
  set( _testlibname libMOAB.so )
  set( _libsearchpath ${DTOO_EXTERNLIBS}/ALL/lib )
  #find the include dir by looking for moab/Version.h
  FIND_PATH( MOAB_INCLUDE_DIR moab/Version.h PATHS ${_incsearchpath} DOC "Path to MOAB foam includes" )
  ...
  FIND_PATH( MOAB_LINK_DIRECTORY ${_testlibname} PATH ${_libsearchpath} DOC "Path to MOAB libs" )
  ...
  ELSE( MOAB_LINK_DIRECTORY STREQUAL ${_testlibname}-NOTFOUND )
    ...
    MESSAGE( STATUS "Found MOAB include dir: ${MOAB_INCLUDE_DIR}" )
    MESSAGE( STATUS "Found MOAB lib dir: ${MOAB_LINK_DIRECTORY}" )
...
IF( MOAB_FOUND STREQUAL TRUE )
  IF( DEFINED MOAB_FIND_COMPONENTS )
    FOREACH( _libname ${MOAB_FIND_COMPONENTS} )
      ...
      FIND_LIBRARY( ${_libname}_MOABLIB ${_libname} ${MOAB_LINK_DIRECTORY} ${MOAB_LINK_DIRECTORY}/openmpi-system NO_DEFAULT_PATH)
      SET( _foundlib ${${_libname}_MOABLIB} )
      IF( _foundlib STREQUAL ${_libname}_MOABLIB-NOTFOUND )
        MESSAGE( FATAL_ERROR "Cannot find ${_libname}. Is it spelled correctly? Correct capitalization? Do you have another package with similarly-named libraries, installed at ${MOAB_LINK_DIRECTORY}? (That is where this script thinks the MOAB libs are.)" )
  ...
  ELSE( DEFINED MOAB_FIND_COMPONENTS )
    MESSAGE( AUTHOR_WARNING "Developer must specify required libraries to link against in the cmake file, i.e. find_package( MOAB REQUIRED COMPONENTS TKernel TKBRep) . Otherwise no libs will be added - linking against ALL MOAB libraries is slow!")
