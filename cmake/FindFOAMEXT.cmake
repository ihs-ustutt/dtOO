...
IF ( "$ENV{WM_FORK}" STREQUAL "extend" )
...
ELSE( "$ENV{WM_FORK}" STREQUAL "extend" )
  MESSAGE(
    "**> No foam-ext Version initialized. Environment variable WM_FORK is "
    "not extend\n"
    "**>   WM_FORK=$ENV{WM_FORK}"
  )
ENDIF( "$ENV{WM_FORK}" STREQUAL "extend" )
